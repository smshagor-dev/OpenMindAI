...
void main() {
  ...
  test('rejects executable SVG content', () {
    const input = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10"><script>alert(1)</script></svg>''';
    expect(
  ...
  test('rejects external href content', () {
    const input = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10"><a href="https://example.com"><rect width="10" height="10"/></a></svg>''';
    expect(
      () => sanitizeGeneratedSvg(input),
      throwsA(isA<CanvasGenerationException>()),
    );
