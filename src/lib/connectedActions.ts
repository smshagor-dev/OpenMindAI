...
export const CONNECTED_ACTIONS: ConnectedActionDefinition[] = [
  ...
  github("pr.merge", "GitHub · Merge PR", "Merge only the exact observed pull-request head using merge/squash/rebase.", true, { repo: "owner/repo", number: 1, mergeMethod: "squash", expectedHeadSha: "0123456789abcdef0123456789abcdef01234567" }),
  ...
  microsoft("calendar.update", "Outlook Calendar · Update event", "Patch an event.", true, { eventId: "EVENT_ID", event: { subject: "Updated title" } }),
