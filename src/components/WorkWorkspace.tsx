...
const QUICK_TASKS = [
  {
    ...
    prompt:
      "Research this project and give me a concise brief with the key findings, risks, and next steps.",
    icon: Search,
  },
  {
    ...
    prompt:
      "Create a polished deliverable from this project context. Choose the most useful format and make it ready to use.",
    icon: FileText,
  },
  {
    ...
    prompt:
      "Analyze this project thoroughly, identify the most important gaps or issues, and recommend the next actions in priority order.",
    icon: Sparkles,
  },
  {
    ...
    prompt:
      "Inspect this project, find the highest-impact issue or improvement, implement it, and validate the result.",
    icon: CheckCircle2,
  },
] as const;
          ...
          <>
            ...
            >
              ...
              <div className="cg-work-composer-footer">
                <div className="cg-work-composer-tools">
                  ...
                  >
                    {addingFiles ? <LoaderCircle className="spin" size={18} /> : <Plus size={19} />}
                  </button>
            ...
            <div className="cg-work-shortcuts" aria-label="Suggested tasks">
              {QUICK_TASKS.map((task) => {
                ...
                return (
                  <button key={task.title} type="button" onClick={() => setWorkDraft(task.prompt)}>
              ...
              <div className="cg-work-project-chat-panel">
                <div className="cg-work-subheading">
                  ...
                  <button
                    type="button"
                    disabled={busy}
                    onClick={() => void startWork("Start a new work thread for this project.")}
                  >
